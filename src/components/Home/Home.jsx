...
const Home = () => {
    return (
        <section className='container mx-auto'>
            <div className="home-main grid grid-cols-2 items-center py-6">
                <div className="home-left">
                    ...
                    <Link to={'/login'}>
                        <button type="button" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-lg px-10 py-5 text-center me-2 mb-2 flex items-center">
                            Get Started
